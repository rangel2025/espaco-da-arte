          ...
          <div className="relative flex justify-center lg:justify-end">
            ...
            >
              <Image
                ...
                alt="Professora e artista no ateliê"
                fill
            ...
            <div
              className="absolute -bottom-12 -left-16 z-20 hidden lg:block"
              style={{
                background: "var(--color-surface-container-lowest)",
                borderRadius: "2.5rem",
                padding: "1.5rem",
                boxShadow: "0 40px 80px rgba(138,72,83,0.18)",
                width: "240px",
                animation: "drift 10s ease-in-out infinite reverse",
              }}
            >
              <div className="relative h-32 rounded-3xl overflow-hidden mb-4 border border-white/20">
                <Image
                  src="/images/turma-nova.jpg"
                  alt="Turma de alunos no ateliê"
                  fill
